...
description: A simple react hook for creating portals for next.js.
...
```tsx title="src/hooks/usePortal.ts"
...
You can now also use this hook via npm/yarn by installing [my npm package](https://npm.im/@casperiv/useful):
