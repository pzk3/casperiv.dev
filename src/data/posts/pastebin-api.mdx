...
<Alert type="info" style={{ margin: "0.8rem 0" }}>
  Replace <code>process.env["API_KEY_HERE"]</code> with your own api key from Pastebin. You can also
  add it in a <code>.env</code> file.
</Alert>
