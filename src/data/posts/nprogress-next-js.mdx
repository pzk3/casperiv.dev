...
To use the module, open your `_app.tsx` file. First we must import the required styles from
nprogress.

<Info title="Custom app">
  If you do not have an app file, you can copy this template below. This example comes [from Next.js' docs](https://nextjs.org/docs/advanced-features/custom-app).
