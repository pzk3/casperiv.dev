  ...
  ["border-2 rounded-2xl text-base font-inter font-medium transition outline-none"],
  {
    variants: {
      intent: {
        ...
        secondary:
          "border-gray-light text-secondary hover:border-accent focus-visible:border-accent",
        "secondary-light":
          "border-gray-light text-primary hover:border-accent focus-visible:border-accent",
