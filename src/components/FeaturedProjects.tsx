      ...
      <ul className="flex gap-1 mt-2">
        {project.buttons.map((button) => (
          <li key={button.name}>
            <Link
              href={button.url}
              className="p-2 px-3.5 rounded-md bg-gray-300 focus:bg-gray-400/80 hover:bg-gray-400/80 dark:bg-blue-3 dark:focus:bg-blue-3/70 dark:hover:bg-blue-3/70 transition-colors"
            >
              {button.name}
            </Link>
          </li>
