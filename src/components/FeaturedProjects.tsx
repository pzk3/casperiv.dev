...
const ProjectItem = ({ project }: { project: Project }) => {
  return (
    <li className="flex flex-col justify-between p-4 transition-transform rounded-md shadow-sm bg-blue-1 focus-within:scale-[1.008] hover:scale-[1.008] cursor-default">
