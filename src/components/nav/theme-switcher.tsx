...
export function ThemeSwitcher() {
  ...
  return (
    ...
    >
      <span className="block absolute inset-0 transition-all opacity-0 group-hover:opacity-100 bg-gradient-to-tr hover:from-[#1150d4] hover:to-[#a245fc] z-0 duration-200" />
